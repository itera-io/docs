...
<Frame caption="Projects Overwiev">
  ![](images/create.a.project.webp)
</Frame>

<Frame caption="Projects Overwiev">
  ![](usage-reports-price-development-ezgif.com-video-to-webp-converter.webp)
</Frame>
...
<Steps>
  ...
  <Step title="Click the Add Project button">
    Locate and click the **Add Project** button in the top rigccht corner.
  </Step>
...
## Additional Resources hg

For a comprehensive understanding of the project creation process, watch our instructional video below:

<iframe width="560" height="315" src="https://www.youtube.com/embed/XUFtmCr01Lc?start=54" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen />