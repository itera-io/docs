...
Below is an example of a group blob store:

![example\_group\_blob\_store.png](https://help.sonatype.com/en/image/uuid-15eb32d9-a7df-f35d-0186-0bf3b38cf5e2.png)
...
![Example\_Health\_Check\_Overview.png](https://help.sonatype.com/en/image/uuid-aa0d4d86-31a1-73b1-01cd-9b006caeaf88.png)
