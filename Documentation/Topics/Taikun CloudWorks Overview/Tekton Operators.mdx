...
<CardGroup cols={3}>
  <Card title="Tekton Pipeline" />
   Automate CI/CD processes with flexible pipelines. HERE
  <Card title="Tekton Trigger" />
   Trigger pipelines based on events. HERE
  <Card title="Tekton Dashboard" />
   Get a visual overview of running pipelines. HERE
  <Card title="Tekton Result" />
   Track and analyze pipeline results. HERE
  <Card title="Tekton Chain" />
   Ensure artifact integrity and auditability. HERE
  <Card title="Piplines as a Code" />
    Manage pipelines directly in your repository. HERE
</CardGroup>
