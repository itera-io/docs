...
[`storage/storageclass-low-latency.yaml` ](https://raw.githubusercontent.com/kubernetes/website/main/content/en/examples/storage/storageclass-low-latency.yaml)![](https://kubernetes.io/images/copycode.svg)
...
[Azure File](https://kubernetes.io/docs/concepts/storage/storage-classes/#azure-file)
...
[NFS](https://kubernetes.io/docs/concepts/storage/storage-classes/#nfs)

PortworxVolume

✓

[Portworx Volume](https://kubernetes.io/docs/concepts/storage/storage-classes/#portworx-volume)
...
[vSphere](https://kubernetes.io/docs/concepts/storage/storage-classes/#vsphere)
