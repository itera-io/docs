...
This feature helps the users to manage their project status. By using this feature, users can reset their project status. In some cases, we need to change the status of the projects, So we do it with this feature. Below are all possible statuses that we use with this feature
