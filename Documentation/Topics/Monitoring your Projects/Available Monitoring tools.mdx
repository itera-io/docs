...
<AccordionGroup>
  ...
  <Accordion title="K8s Infra" icon="circle-nodes">
  ...
  <Accordion title="Events" icon="list-check">
  ...
  <Accordion title="Logs" icon="calendar-days">
    This button allows you to view detailed Grafana logs for your cluster.
  </Accordion>

  <Accordion title="Alerts" icon="calendar-days">
