...
<Card title="Prometheus" icon="desktop" horizontal={true} href="https://prometheus.io/">
  With that, Taikun will send all notifications from Prometheus to the tool of your choice. You can click HERE and learn more about Prometheus. 
</Card>