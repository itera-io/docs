...
<AccordionGroup>
  <Accordion title="Enable monitoring during the Project creation" icon="chart-column">
  ...
  <Accordion title="Alternatively, it can be activated in the already created Projects" icon="table-columns">
    <Frame caption="Enable Monitoring">
