...
<Card title="Backup system" icon="right-to-bracket" horizontal={true} href="Documentation/Topics/Managing your Projects/Backup.mdx">
...
<Card title="Showback" icon="eye" horizontal={true} href="Documentation/Topics/Monitoring your Projects/Showback rules.mdx">
