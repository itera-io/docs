...
Taikun allows you to install applications to Kubernetes clusters directly from the web interface.

Access the *Applications* section in the left-hand navigation panel to find the following tabs.

<Card title="Installing Applications" icon="download" horizontal={true} href="Documentation/Topics/Managing your Projects/Installing Applications.mdx">
  Check this article to see how to install applications in Taikun.
</Card>
