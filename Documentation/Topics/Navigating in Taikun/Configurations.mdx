...
<CardGroup cols={2}>
  <Card title="Configuring a token" icon="wrench" horizontal={true} href="Documentation/Topics/Advanced Configuration/Taikun API.mdx">
    Detailed instructions on configuring a token can be found HERE.
  </Card>

  <Card title="API documentation" icon="files" horizontal={true} href="https://api.taikun.cloud/?_gl=1*1qqu7uo*_up*MQ..*_ga*MTM1NjMzNjE1My4xNzMyNjk3ODg3*_ga_DSY6GPP30P*MTczMjY5Nzg4Ni4xLjEuMTczMjY5OTAxNy4wLjAuMA..">
