...
<Card title="Microsoft Azure" icon="a" horizontal={true} href="https://azure.microsoft.com/">
...
<Card title="Microsoft Azure" icon="a" horizontal={true} href="https://github.com/kubernetes-sigs/kubespray/blob/master/docs/cloud_providers/azure.md">
...
1. Create a new Azure App with the following command:
...
<Card title="Microsoft Azure" icon="a" horizontal={true} href="https://www.inkoop.io/blog/how-to-get-azure-api-credentials/">
