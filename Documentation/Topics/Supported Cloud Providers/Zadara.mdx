...
A zCompute machine image named with the prefix “taikun” (eg “taikun-server”) either created from the Zadara marketplace or direct from the following image&#x20;

URL: [https://rgw.cloudpoint.tcpro.cz/taikun-cloud-files/images/ubuntu-jammy-22.04.qcow2](https://rgw.cloudpoint.tcpro.cz/taikun-cloud-files/images/ubuntu-jammy-22.04.qcow2)
