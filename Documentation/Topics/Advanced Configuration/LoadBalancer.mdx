...
<Note>taikun-lb is only available for OpenStack with Octavia disabled. You need to add the image **https://repo.itera.io/repository/images/taikun-lb.qcow2** to OpenStack with the tag “taikun-lb”.</Note>
