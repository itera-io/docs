...
**Networking back ends, supported rules, and traffic direction**[¶](https://taikun.cloud/docs/quality-of-service-qos/#id1 "Permalink to this table")
...
**Neutron backends, supported directions and enforcement types for Minimum Bandwidth rule**[¶](https://taikun.cloud/docs/quality-of-service-qos/#id2 "Permalink to this table")
...
**Neutron backends, supported directions and enforcement types for Minimum Packet Rate rule**[¶](https://taikun.cloud/docs/quality-of-service-qos/#id3 "Permalink to this table")
...
**L3 service, supported extension, and traffic direction**[¶](https://taikun.cloud/docs/quality-of-service-qos/#id4 "Permalink to this table")
...
### DSCP marking on outer header for overlay networks[¶](https://docs.openstack.org/neutron/zed/admin/config-qos.html#dscp-marking-on-outer-header-for-overlay-networks)
