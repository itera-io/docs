...
![](https://docs.ceph.com/en/latest/_images/ditaa-b5b3c1e5436bc4194b054c832b1538529c89979f.png)

> ImportantTo use Ceph Block Devices with OpenStack, you must have access to a running Ceph Storage Cluster.
...
> ImportantYou don’t necessarily need the UUID on all the compute nodes. However from a platform consistency perspective, it’s better to keep the same UUID.
...
> TipIf your virtual machine is already running you can simply restart it to enable the admin socket
