...
`| Field        | Value                                    |`
`+--------------+------------------------------------------+`
`| adminurl     | `[`http://radosgw.example.com:8080/swift/v1`](http://radosgw.example.com:8080/swift/v1)` |`
`| id           | e4249d2b60e44743a67b5e5b38c18dd3         |`
`| internalurl  | `[`http://radosgw.example.com:8080/swift/v1`](http://radosgw.example.com:8080/swift/v1)` |`
`| publicurl    | `[`http://radosgw.example.com:8080/swift/v1`](http://radosgw.example.com:8080/swift/v1)` |`
`| region       | RegionOne                                |`
...
> NoteIf your radosgw `ceph.conf` sets the configuration option `rgw swift account in url = true`, your `object-store` endpoint URLs must be set to include the suffix `/v1/AUTH_%(tenant_id)s` (instead of just `/v1`).
