---
title: "Installing Taikun OCP Baremetal"
---
...
<CardGroup cols={2}>
  <Card title="Debian-based 1" icon="D" horizontal="yes" href="https://docs.docker.com/engine/install/debian/" />

  <Card title="RedHat-based 1" icon="R" horizontal="yes" href="https://docs.docker.com/engine/install/centos/" />
</CardGroup>
