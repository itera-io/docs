...
You want to administer and maintain a Glance installation, including being aware of changes in Glance from release to release.
...
Here’s a handy [Glossary](https://docs.openstack.org/glance/zed/glossary.html) of terms related to Glance