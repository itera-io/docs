...
GuestGuest BitnessHost VersionHost CPUHost BitnessStatus
...
> > NoteAll OS versions newer than the ones listed in the tables below are supported by the KVM.
...
qemu-kvm.x86\_64 10:1.5.3-60.el7\_0.5
