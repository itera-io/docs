...
`[[local|localrc]]`
`enable_plugin octavia `[`https://opendev.org/openstack/octavia`](https://opendev.org/openstack/octavia)
`# If you are enabling horizon, include the octavia dashboard`
`# enable_plugin octavia-dashboard `[`https://opendev.org/openstack/octavia-dashboard.git`](https://opendev.org/openstack/octavia-dashboard.git)
`# If you are enabling barbican for TLS offload in Octavia, include it here.`
`# enable_plugin barbican `[`https://opendev.org/openstack/barbican`](https://opendev.org/openstack/barbican)
