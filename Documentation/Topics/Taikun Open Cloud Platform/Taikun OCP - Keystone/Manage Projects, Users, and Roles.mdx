---
title: "Manage Projects, Users, and Roles"
---
...
## Projects[¶](https://taikun.cloud/docs/manage-projects-users-and-roles/#projects "Permalink to this headline")
...
### List projects[¶](https://taikun.cloud/docs/manage-projects-users-and-roles/#list-projects "Permalink to this headline")
...
### Create a project[¶](https://taikun.cloud/docs/manage-projects-users-and-roles/#create-a-project "Permalink to this headline")
...
### Update a project[¶](https://taikun.cloud/docs/manage-projects-users-and-roles/#update-a-project "Permalink to this headline")
...
### Delete a project[¶](https://taikun.cloud/docs/manage-projects-users-and-roles/#delete-a-project "Permalink to this headline")

Specify the project ID to delete a project:

$ openstack project delete PROJECT\_ID

## Users[¶](https://taikun.cloud/docs/manage-projects-users-and-roles/#users "Permalink to this headline")

### List users[¶](https://taikun.cloud/docs/manage-projects-users-and-roles/#list-users "Permalink to this headline")
...
### Create a user[¶](https://taikun.cloud/docs/manage-projects-users-and-roles/#create-a-user "Permalink to this headline")
...
### Update a user[¶](https://taikun.cloud/docs/manage-projects-users-and-roles/#update-a-user "Permalink to this headline")

You can update the name, email address, and enabled status for a user.

* To temporarily disable a user account:
  $ openstack user set USER\_NAME --disableIf you disable a user account, the user cannot log in to the dashboard. However, data for the user account is maintained, so you can enable the user at any time.

* To enable a disabled user account:
  $ openstack user set USER\_NAME --enable

* To change the name and description for a user account:
  $ openstack user set USER\_NAME --name user-new --email [new-user@example.com](mailto:new-user@example.com)
  User has been updated.

### Delete a user[¶](https://taikun.cloud/docs/manage-projects-users-and-roles/#delete-a-user "Permalink to this headline")

Delete a specified user account:

$ openstack user delete USER\_NAME

## Roles and role assignments[¶](https://taikun.cloud/docs/manage-projects-users-and-roles/#roles-and-role-assignments "Permalink to this headline")

### List available roles[¶](https://taikun.cloud/docs/manage-projects-users-and-roles/#list-available-roles "Permalink to this headline")
...
### Create a role[¶](https://taikun.cloud/docs/manage-projects-users-and-roles/#create-a-role "Permalink to this headline")
...
### Assign a role[¶](https://taikun.cloud/docs/manage-projects-users-and-roles/#assign-a-role "Permalink to this headline")

To assign a user to a project, you must assign the role to a user-project pair.

1. Assign a role to a user-project pair:
   $ openstack role add --user USER\_NAME --project PROJECT\_NAME ROLE\_NAMEFor example, assign the `new-role` role to the `demo` user and `test-project` project pair:
   $ openstack role add --user demo --project test-project new-role

2. Verify the role assignment:
   $ openstack role assignment list --user USER\_NAME \\
   &#x20; \--project PROJECT\_NAME --names
   +-------------+--------------+-------+--------------+--------+--------+-----------+
...
### View role details[¶](https://taikun.cloud/docs/manage-projects-users-and-roles/#view-role-details "Permalink to this headline")
...
### Remove a role[¶](https://taikun.cloud/docs/manage-projects-users-and-roles/#remove-a-role "Permalink to this headline")
...
2. Verify the role removal:
   $ openstack role assignment list --user USER\_NAME --project PROJECT\_NAME --namesIf the role was removed, the command output omits the removed role.

### Creating implied roles[¶](https://taikun.cloud/docs/manage-projects-users-and-roles/#creating-implied-roles "Permalink to this headline")
...
\| prior\_role | 29c09e68e6f741afa952a837e29c700b |
+------------+----------------------------------+
...
### Listing implied roles[¶](https://taikun.cloud/docs/manage-projects-users-and-roles/#listing-implied-roles "Permalink to this headline")
...
### Deleting implied roles[¶](https://taikun.cloud/docs/manage-projects-users-and-roles/#deleting-implied-roles "Permalink to this headline")
