...
[![Figure 1: Audit middleware in Nova pipeline](https://docs.openstack.org/keystonemiddleware/zed/_images/audit.png)](https://docs.openstack.org/keystonemiddleware/zed/_images/audit.png)
