---
title: "Configuring Keystone for Federation"
---
...
`$ openstack identity provider create --remote-id `[`https://samltest.id/saml/idp`](https://samltest.id/saml/idp)` samltest`
...
`$ curl -s `[`https://samltest.id/saml/idp`](https://samltest.id/saml/idp)` | grep -o 'entityID=".*"'`
...
`[federation]`
`trusted_dashboard = `[`https://horizon1.example.org/auth/websso/`](https://horizon1.example.org/auth/websso/)
`trusted_dashboard = `[`https://horizon2.example.org/auth/websso/`](https://horizon2.example.org/auth/websso/)
...
`$ curl -s `[`https://samltest.id/saml/idp`](https://samltest.id/saml/idp)` | grep urn:oasis:names:tc:SAML:2.0:bindings:SOAP`
...
![](https://docs.openstack.org/keystone/zed/_images/horizon-login-sp.png)
...
[`idp_contact_email=jsmith@example.com`](mailto:idp_contact_email=jsmith@example.com)
...
`--service-provider-url `[`https://sp.keystone.example.org/Shibboleth.sso/SAML2/ECP`](https://sp.keystone.example.org/Shibboleth.sso/SAML2/ECP)
`--auth-url `[`https://sp.keystone.example.org/v3/OS-FEDERATION/identity_providers/keystoneidp/protocols/saml2/auth`](https://sp.keystone.example.org/v3/OS-FEDERATION/identity_providers/keystoneidp/protocols/saml2/auth)
...
`$ curl -s `[`https://sp.keystone.example.org/Shibboleth.sso/Metadata`](https://sp.keystone.example.org/Shibboleth.sso/Metadata)` | grep urn:oasis:names:tc:SAML:2.0:bindings:PAOS`
...
![](https://docs.openstack.org/keystone/zed/_images/horizon-login-idp.png)
...
`OIDCProviderMetadataURL `[`https://accounts.google.com/.well-known/openid-configuration`](https://accounts.google.com/.well-known/openid-configuration)
`OIDCOAuthVerifyJwksUri `[`https://www.googleapis.com/oauth2/v3/certs`](https://www.googleapis.com/oauth2/v3/certs)
`OIDCClientID <openid_client_id>`
`OIDCClientSecret <openid_client_secret>`
`OIDCCryptoPassphrase <random string>`
`OIDCRedirectURI `[`https://sp.keystone.example.org/v3/OS-FEDERATION/identity_providers/google/protocols/openid/auth`](https://sp.keystone.example.org/v3/OS-FEDERATION/identity_providers/google/protocols/openid/auth)
...
`OIDCCryptoPassphrase <random string>`
`OIDCRedirectURI `[`https://sp.keystone.example.org/redirect_uri`](https://sp.keystone.example.org/redirect_uri)
...
#### Configure Protected Endpoints[¶](https://docs.openstack.org/keystone/zed/admin/federation/configure_federation.html#id7)
...
#### Configure the Mellon Service Provider Metadata[¶](https://docs.openstack.org/keystone/zed/admin/federation/configure_federation.html#configure-the-mellon-service-provider-metadata)
...
[`https://sp.keystone.example.org/mellon`](https://sp.keystone.example.org/mellon)` \`
[`http://sp.keystone.example.org/v3/OS-FEDERATION/identity_providers/samltest/protocols/saml2/auth/mellon`](http://sp.keystone.example.org/v3/OS-FEDERATION/identity_providers/samltest/protocols/saml2/auth/mellon)
...
`$ wget -O /etc/apache2/mellon/idp-metadata.xml `[`https://samltest.id/saml/idp`](https://samltest.id/saml/idp)

Remember to reload Apache after finishing configuring Mellon:

`# systemctl reload apache2`

#### Continue configuring keystone[¶](https://docs.openstack.org/keystone/zed/admin/federation/configure_federation.html#id8)

[Continue configuring keystone](https://docs.openstack.org/keystone/zed/admin/federation/configure_federation.html#federation-configuring-keystone)

## Setting up Shibboleth[¶](https://docs.openstack.org/keystone/zed/admin/federation/configure_federation.html#setting-up-shibboleth)
...
`# wget `[`https://sp.keystone.example.org/Shibboleth.sso/Metadata`](https://sp.keystone.example.org/Shibboleth.sso/Metadata)
