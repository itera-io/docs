...
<Card title="Getting Started with Taikun CloudWorks" icon="rocket" horizontal={true} href="/docs/getting-started">
...
<Card title="Navigating in Taikun CloudWorks" icon="compass" horizontal={true} href="/docs/navigating-taikun">
...
<Card title="Managing Your Projects" icon="folder" horizontal={true} href="/docs/managing-projects">
...
<Card title="Monitoring Your Projects" icon="eye" horizontal={true} href="/docs/monitoring-projects">
...
<Card title="Profile Management" icon="user" horizontal={true} href="/docs/profile-management">
...
<Card title="Account Management" icon="lock" horizontal={true} href="/docs/account-management">
...
<Card title="Advanced Configuration" icon="wrench" horizontal={true} href="/docs/advanced-configuration">
...
<Card title="Taikun CloudWorks Dictionary" icon="book" horizontal={true} href="/docs/lingo">
