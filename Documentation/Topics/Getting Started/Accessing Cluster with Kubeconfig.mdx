...
- <Icon icon="pencil" size={24} /> **Edit HTTP Proxy** – Update the access profile.
- <Icon icon="trash-alt" size={24} /> **Delete** – Delete an access profile; however, the default profile cannot be deleted.
