...
<Frame caption="Access Kubernetes Cluster with Bash">
  ![](https://mintlify.s3-us-west-1.amazonaws.com/taikuncloud/Documentation/Images/Getting%20Started/kubeconfig.bash.png)
</Frame>
